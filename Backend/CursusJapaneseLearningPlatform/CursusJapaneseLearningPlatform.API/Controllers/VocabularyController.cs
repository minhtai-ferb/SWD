...
namespace CursusJapaneseLearningPlatform.API.Controllers
{
    ...
    public class VocabularyController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateVocabulary(VocabularyRequestModel request)
        {
        ...
        [HttpPut("{id}")]
        [Authorize(Roles = "Admin")]
        public async Task<IActionResult> UpdateVocabulary(Guid id, VocabularyRequestModel request)
        {
