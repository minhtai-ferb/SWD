...
namespace CursusJapaneseLearningPlatform.API.Controllers
{
    ...
    public class CollectionController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateCollection(CollectionRequestModel request)
        {
        ...
        [HttpPut("{id}")]
        [Authorize(Roles = "Learner")]
        public async Task<IActionResult> UpdateCollection(Guid id, CollectionRequestModel request)
        {
